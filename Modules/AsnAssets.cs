...
{
    internal static class AsnAssets
    {
        ...
        //internal static AssetBundle projBundle;
        ...
        internal static AssetBundle LoadAssetBundle(string bundleName)
        {
            ...
            try
            {
                assetBundle = AssetBundle.LoadFromFile(Path.Combine(Path.GetDirectoryName(AssassinPlugin.instance.Info.Location), "AssetBundles", bundleName));
            }
            ...
            if (assetBundle == null)
            {
                try
                {
                    assetBundle = AssetBundle.LoadFromFile(Path.Combine(Path.GetDirectoryName(AssassinPlugin.instance.Info.Location), "AssassinMod/plugins/AssetBundles", bundleName));
                }
                catch (System.Exception e)
                {
        ...
        internal static GameObject CreateProjectileGhostPrefab(this AssetBundle assetBundle, string ghostName)
        {
            ...
            Modules.AsnAssets.ConvertAllRenderersToHopooShader(ghostPrefab);
