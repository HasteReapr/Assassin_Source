...
namespace AssassinMod.Modules
{
    internal static class Assets
    {
        ...
        internal static AssetBundle LoadAssetBundle(string bundleName)
        {
            ...
            AssetBundle projectileBundle = null;
            try
            {
                ...
                projectileBundle = AssetBundle.LoadFromFile(Assembly.GetExecutingAssembly().Location.Replace("AssassinMod.dll", "assassin_projectiles"));
            }
